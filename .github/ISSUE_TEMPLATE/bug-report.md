...
about: Report a bug in OWASP Coffee Shop
title: '[🐛] '
labels: bug
assignees: ''
...
Please also make sure to check the official [Troubleshooting guide](https://pwning.owasp-Coffee.shop/appendix/troubleshooting.html) before opening a bug report.
