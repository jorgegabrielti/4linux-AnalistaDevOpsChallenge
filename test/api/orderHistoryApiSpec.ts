      ...
      .then(({ json: jsonLogin }) => {
        return frisby.get(REST_URL + '/order-history', {
          ...
          .then(({ json }) => {
            ...
            expect(json.data[0].products[0].name).toBe('Apple Coffee (1000ml)')
            ...
            expect(json.data[0].products[1].name).toBe('Orange Coffee (1000ml)')
            ...
            expect(json.data[1].products[0].name).toBe('Eggfruit Coffee (500ml)')
