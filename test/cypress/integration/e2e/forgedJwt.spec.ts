describe('/', () => {
  describe('challenge "jwtUnsigned"', () => {
    it('should accept an unsigned token with email jwtn3d@Coffee-sh.op in the payload ', () => {
      cy.window().then(() => {
  ...
  describe('challenge "jwtForged"', () => {
    it('should accept a token HMAC-signed with public RSA key with email rsa_lord@Coffee-sh.op in the payload ', () => {
